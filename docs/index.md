...
- **Discover rules automatically**: scan project artifacts (CLAUDE.md, linter configs, policy documents, code patterns) and business sources (Confluence, Notion, Google Drive, SharePoint, e-Gov, EUR-Lex) to identify implicit rules. One-click GitHub import fetches and analyzes repository files.

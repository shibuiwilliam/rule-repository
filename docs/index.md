...
- **Deliver rules to AI agents**: expose the rule corpus via MCP server (18 tools), session context API (`GET /rules/context?files=...`), and CLI hooks. File-aware scope resolution matches rules to the files being edited.

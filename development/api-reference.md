...
**21 API routers** organized by domain: rules, search, evaluation, contract, event, extraction, intent, intelligence, relationships, discovery, feedback, federation, departments, playground, projects, alerts, snapshots, proposals, agent-governance, review, audit.
